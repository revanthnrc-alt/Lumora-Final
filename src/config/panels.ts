...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  watchtower: { name: 'Watchtower Agent', enabled: true, priority: 1 },
  investigation: { name: 'Investigation Agent', enabled: true, priority: 1 },
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  intelligence: {
    ...
    panelKeys: ['cii', 'strategic-risk', 'intel', 'gdelt-intel', 'cascade', 'telegram-intel', 'watchtower', 'investigation'],
    variants: ['full'],
  },
  regionalNews: {
